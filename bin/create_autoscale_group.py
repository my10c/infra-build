...
def main():
    ...
    for autoscale_group in groups_data:
        ...
        # TODO
        # make sure yaml has ARN's configured
        for target_name in group_data['TargetGroupARNs']:
            arn_list.append(GET_TARGET_ARN(target_name))
        try:
            result = autoscale_conn.create_auto_scaling_group(
